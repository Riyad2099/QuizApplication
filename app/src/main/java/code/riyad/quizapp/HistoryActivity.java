...
import code.riyad.quizapp.adapter.HistoryAdapter;
import code.riyad.quizapp.data.Attempt;
import code.riyad.quizapp.data.UserDatabase;
import code.riyad.quizapp.data.UserDatabaseClient;
import code.riyad.quizapp.data.UserWithAttempts;
import code.riyad.quizapp.other.SharedPref;
